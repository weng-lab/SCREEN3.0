...
export type ComputationalGeneLinksQuery = { __typename?: 'Query', ComputationalGeneLinksQuery?: Array<{ __typename?: 'ComputationalGeneLinks', genename: string, geneid: string, genetype: string, method: string, celltype: string, score: number, methodregion: string, fileaccession: string } | null> | null };
