...
export type BiosampleZScoresQuery = { __typename?: 'Query', ccREBiosampleQuery: { __typename?: 'RegistryBiosampleCollection', biosamples?: Array<{ __typename?: 'RegistryBiosample', sampleType: string, displayname: string, name: string, ontology: string, id: string, cCREZScores: Array<{ __typename?: 'CCREZScore', score: number, assay: string, experiment_accession: string }> }> | null } };
