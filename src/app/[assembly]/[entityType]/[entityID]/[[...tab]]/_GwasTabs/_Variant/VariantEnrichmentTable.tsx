...
import { useCcreBiosampleData } from "common/hooks/useCcreBiosamplesData";
...
export type VariantEnrichmentTableProps = {
...
const VariantEnrichmentTable = ({ enrichmentdata, onSelectionChange, setSortedFilteredData, selected, sortedFilteredData }: VariantEnrichmentTableProps) => {
...
export default VariantEnrichmentTable;