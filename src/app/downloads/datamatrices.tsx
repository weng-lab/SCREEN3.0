...
export function DataMatrices() {
  ...
  const handleSetSearchedSample = (biosample: [EncodeBiosample]) => {
    if (biosample[0]?.displayname) {
      setSearchedBiosample(biosample[0]);
  ...
  const scatterData: Point<PointMetaData>[] = useMemo(() => {
    ...
    return fData.map((x) => {
      ...
      return {
        ...
        r: searchedBiosample && x.displayname === searchedBiosample.displayname ? 5 : 2,
        color:
          searchedBiosample === null || x.displayname === searchedBiosample.displayname
