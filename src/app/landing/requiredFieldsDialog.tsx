...
const RequiredFieldsDialog: React.FC<RequiredFieldsDialogProps> = ({ open, onClose }) => (
  <Dialog
    open={open}
    onClose={onClose}
    PaperProps={{
  ...
  >
    ...
    <DialogContent sx={{ px: 3, pt: 0, pb: 2 }}>
      ...
      <Typography variant="body1" mb={2}>
        • If using the text box, separate fields with a tab. Below is an example file to help you format your data
        correctly.
      </Typography>
